...
current_deployment_info=$(curl -H "Authorization: Basic $base64encoded" "https://api.enterprise.apigee.com/v1/organizations/marcelodevopsgarcia-eval/apis/HR-API/deployments") 
